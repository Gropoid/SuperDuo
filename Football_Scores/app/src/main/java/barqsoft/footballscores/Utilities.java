...
public class Utilities
{
    ...
    public static String getMatchDay(Context context, int match_day,int league_num)
    {
        if(league_num == CHAMPIONS_LEAGUE)
        {
            if (match_day <= 6)
            {
                return context.getString(R.string.matchday_group_stage) + String.valueOf(match_day);
            }
            else if(match_day == 7 || match_day == 8)
            {
                return context.getString(R.string.matchday_knockout_round);
            }
        ...
        {
            return context.getString(R.string.matchday_generic) + String.valueOf(match_day);
        }
    }
